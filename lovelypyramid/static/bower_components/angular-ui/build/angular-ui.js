...
*       Can also take in multiple event urls as a source object(s) and feed the events per views.
        ...
        restrict: 'A',
          link: function(scope, elm, attrs, $timeout) {
            ...
            function update() {
              ...
              if(view){
                view = view.name; //setting the default views to be whatever the current views is. This can be overwritten.
              }
  ...
  function () {
    return {
      ...
      link:function ($scope, element, attrs, controller) {
        ...
        /* When keyup, update the views value
         */
    ...
    compile: function (tElm, tAttrs) {
      ...
      return function (scope, elm, attrs, controller) {
        ...
        if (controller) {
          ...
          if (!isSelect) {
            // Set the views and model value and update the angular template manually for the ajax/multiple select2.
