 ...
 *
 * The template function can then be used once to produce the views or as it is the case with
 * {@link angular.module.ng.$compileProvider.directive.ng-repeat repeater} many-times, in which
 * case each call results in a views that is a DOM clone of the original template.
 *
 ...
 *
 * After linking the views is not updateh until after a call to $digest which typically is done by
...
function $RouteProvider(){
   ...
   *      {@link angular.module.ng.$compileProvider.directive.ng-views ng-views} or
  ...
  this.$get = ['$rootScope', '$location', '$routeParams',
     ...
     *
     * The `$route` service is typically used in conjunction with {@link angular.module.ng.$compileProvider.directive.ng-views ng-views}
     * directive and the {@link angular.module.ng.$routeParams $routeParams} service.
     *
     * @example
       This example shows how changing the URL hash causes the `$route` to match a route against the
       URL, and the `ng-views` pulls in the partial.
      ...
      <doc:example module="route">
        ...
        <doc:scenario>
          it('should load and compile correct template', function() {
            ...
            var content = element('.doc-example-live [ng-views]').text();
            expect(content).toMatch(/controller\: ChapterCntl/);
            expect(content).toMatch(/Book Id\: Moby/);
            expect(content).toMatch(/Chapter Id\: 1/);

            element('a:contains("Scarlet")').click();
            content = element('.doc-example-live [ng-views]').text();
    ...
    var matcher = switchRouteMatcher,
        ...
        $route = {
           ...
           *
           * As a result of that, {@link angular.module.ng.$compileProvider.directive.ng-views ng-views}
 ...
 * prefered in order to benefit from progressive rendering of the browser views.
 *
...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-views
 * @restrict ECA
 *
 * @description
 * # Overview
 * `ng-views` is a directive that complements the {@link angular.module.ng.$route $route} service by
...
/**
 * @ngdoc event
 * @name angular.module.ng.$compileProvider.directive.ng-views#$viewContentLoaded
 * @eventOf angular.module.ng.$compileProvider.directive.ng-views
 * @eventType emit on the current ng-views scope
 * @description
 * Emitted every time the ng-views content is reloaded.
 */
 ...
 * template can be used by `ng-include`, `ng-views` or directive templates.
 *
 * @restrict E
