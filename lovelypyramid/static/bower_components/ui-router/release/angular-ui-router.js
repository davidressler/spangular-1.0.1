  ...
  function $get(   $rootScope,   $q,   $templateFactory,   $injector,   $stateParams,   $location,   $urlRouter) {
    ...
    function resolveState(state, params, paramsAreFiltered, inherited, dst) {
      ...
      forEach(state.views, function (view, name) {
        ...
        // views definition in .state(), we can end up with state.resolve === views.resolve.
      ...
      // into the dependency set for each views. Finally return a promise
  ...
  var directive = {
    ...
    link: function(scope, element, attr) {
      ...
      function updateView(doAnimate) {
        ...
        // Destroy previous views scope and remove content (if any)
        if (viewScope) {
