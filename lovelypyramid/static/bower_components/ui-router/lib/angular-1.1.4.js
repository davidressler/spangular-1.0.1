 ...
 * preferred in order to benefit from progressive rendering of the browser views.
 *
 ...
 *
 * @animations
 * enter - happens just after the ngView contents are changed (when the new views DOM element is inserted into the DOM)
